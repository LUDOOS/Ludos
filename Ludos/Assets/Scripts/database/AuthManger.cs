...
public class AuthManger : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            Debug.Log("Destroy CreateInstance ");
    ...
    private void InitializeFirebase()
    {
        ...
        //test("LnfkE4YvztalBiqIVBPR7efvdhr1");
    ...
    private IEnumerator AddUserINFO() {
        ...
        //test method 
        //AddChildren(1,"Hima",22);
        //AddChildren(1,"Ali",22);
        //AddChildren(1,"7oss",22);
        //test("LnfkE4YvztalBiqIVBPR7efvdhr1");
        //UpdateChildrenData(1, Children.Achievements, 0, "ID");
        //UpdateChildrenData(1,Children.Name,"Ali");
    }
    //TODO shall we do method for parent : Async ,Delete ,Update still we dont need username And email 
    public void AddChildren(object Avatar ,string ChildName,int ChildAge) {
        //TODO 
        parent._NoChildren++;
        ...
        Children = new Children(Avatar,ChildName,ChildAge,0, new ArrayList() { false }, new ArrayList() { false }, new ArrayList() { false }, new ArrayList() { false }, new ArrayList() { false }, new ArrayList() { false });
    ...
    public void DeleteChildrenData(int NoChildren)
    {
        ...
        {
            parent._NoChildren = parent._NoChildren - 1;
    ...
    public void test(string userid) {
        //var ChildrenRef = db.Collection("parent").Document(userid).Collection("Children");

        //foreach (var item in task.Result)
        //{
        //    Debug.Log(item.ToString());
        //}
        //Query query = ChildrenRef;
        ...
        Query AllQuery = db.Collection("parent").Document(userid).Collection("Children");
        AllQuery.GetSnapshotAsync().ContinueWithOnMainThread(task =>
        {
            ...
            foreach (DocumentSnapshot documentSnapshot in AllQuerySnapshot.Documents)
            {
                ...
                Dictionary<string, object> Children = documentSnapshot.ToDictionary();
                //Children = documentSnapshot.ConvertTo<Children>();
